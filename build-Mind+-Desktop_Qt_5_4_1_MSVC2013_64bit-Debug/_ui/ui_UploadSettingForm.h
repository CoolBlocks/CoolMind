...
"font: 20px \"arial\";"));
        ...
        comboBoxBoard->setMinimumContentsLength(0);
...
"}"));
    ...
    void retranslateUi(QWidget *UploadSettingForm)
    {
        ...
        comboBoxBoard->insertItems(0, QStringList()
         << QApplication::translate("UploadSettingForm", "-------------CoolMakers----------------", 0)
         << QApplication::translate("UploadSettingForm", "CoolMakers Arduino Starter", 0)
         << QApplication::translate("UploadSettingForm", "CoolMakers Arduino Starter Plus", 0)
         << QApplication::translate("UploadSettingForm", "CoolMakers Arduino Standard", 0)
         << QApplication::translate("UploadSettingForm", "CoolMakers Arduino Standard Plus", 0)
        );
        comboBoxBoard->setCurrentText(QApplication::translate("UploadSettingForm", "-------------CoolMakers----------------", 0));
