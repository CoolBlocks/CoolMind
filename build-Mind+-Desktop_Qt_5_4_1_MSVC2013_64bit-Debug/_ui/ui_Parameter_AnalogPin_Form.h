...
"}"));
        ...
        lineEdit->setGeometry(QRect(110, 420, 211, 31));
        lineEdit->setStyleSheet(QStringLiteral("font: 17pt \"Microsoft YaHei UI\";"));
        label = new QLabel(widgetBg);
        label->setObjectName(QStringLiteral("label"));
        label->setGeometry(QRect(70, 420, 31, 25));
        label->setStyleSheet(QLatin1String("color: rgb(105, 105, 105);\n"
"font: 13pt \"Microsoft JhengHei\";"));
        label_2 = new QLabel(widgetBg);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setGeometry(QRect(40, 10, 411, 381));
        label_2->setPixmap(QPixmap(QString::fromUtf8("resource/images/parameter_input/DigitalPin/Arduino Starter.png")));
