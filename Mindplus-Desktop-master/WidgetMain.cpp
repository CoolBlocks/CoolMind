...
#if 0
{
    ...
    connect(listWidgetMenu, SIGNAL(itemClicked(QListWidgetItem*)), this,
...
void WidgetMain::on_pushButtonLoad_clicked()
{
	...
	if(!filePath.isEmpty())
	{
		...
		//query.exec("select * from parameter");	//SLJ
		query.exec("select name,value from parameter");	//SLJ
		while (query.next())
		{
			QString name = query.value(0).toString();	//SLJ
			QString value = query.value(1).toString();	//SLJ
			//QString name = query.value(1).toString();	//SLJ
			//QString value = query.value(2).toString();	//SLJ
...
//SLJ begin
    {//创建Begin面板的listWidget
        //listWidgetBeginner1
        {
            ...
            /*datas.append(ListWidgetBeginData("LEDBLUE" , "Digital Output" , "LED Blue", "./resource/images/coolmakers/singleLedBlue.png"));	//SLJ
            datas.append(ListWidgetBeginData("LEDGREEN" , "Digital Output" , "LED Green", "./resource/images/coolmakers/singleLedGreen.png"));
            datas.append(ListWidgetBeginData("LEDRED" , "Digital Output" , "LED Red", "./resource/images/coolmakers/singleLedRed.png"));*/
			
            //datas.append(ListWidgetBeginData("LED:13" , "Digital Output" , "LED 4", "./resource/images/coolmakers/singleGreenLed.png"));
            //datas.append(ListWidgetBeginData("LED:11" , "Digital Output" , "LED 5", "./resource/images/coolmakers/singleGreenLed.png"));
            //datas.append(ListWidgetBeginData("LED:12" , "Digital Output" , "LED 6", "./resource/images/coolmakers/singleGreenLed.png"));
            
			//SLJ add begin
			//datas.append(ListWidgetBeginData("Infrared\n红外检测" , "Digital Input" , "Infrared 红外检测", "./resource/images/coolmakers/IN000001-M.png"));
			datas.append(ListWidgetBeginData("Inf Block\n障碍检测" , "Digital Input" , "Inf Block 障碍检测", "./resource/images/coolmakers/IN000001-M.png"));
			datas.append(ListWidgetBeginData("Pulse\n脉冲方波" , "Digital Input" , "Pulse 脉冲方波", "./resource/images/coolmakers/IN000002-M.png"));
			datas.append(ListWidgetBeginData("Toggle Switch\n钮子开关" , "Digital Input" , "Toggle Switch 钮子开关", "./resource/images/coolmakers/IN000008-M.png"));

			datas.append(ListWidgetBeginData("Buzzer\n蜂鸣器" , "Digital Output" , "Buzzer 蜂鸣器", "./resource/images/coolmakers/OT000002-M.png"));
			datas.append(ListWidgetBeginData("LED\nLED灯", "Digital Output" , "Buzzer LED灯", "./resource/images/coolmakers/OT000008-M.png"));
			datas.append(ListWidgetBeginData("LED Bar\n彩色灯柱" , "Digital Output" , "LED Bar 彩色灯柱", "./resource/images/coolmakers/OT000012-M.png"));
			datas.append(ListWidgetBeginData("DC Motor\n减速电机" , "Digital Output" , "DC Motor 减速电机", "./resource/images/coolmakers/OT000014-M.png"));
			//SLJ add end			
...
//slj begin
    ...
    {
	splitter->setSizes(QList<int>() << 250 << width()-250);
	on_pushButtonAllBlocks_clicked();
    }
//slj end
    else
    {
...
void WidgetMain::slotItemClicked(QListWidgetItem *item)
{
    int index = listWidgetMenu->row(item);
    stackedWidget->setCurrentIndex(index);
    if(0 == index)
    {
        splitter->setSizes(QList<int>() << 181 << width()-181);
